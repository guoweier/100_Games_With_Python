...
If you want just the Candy Crush project (not the entire 100_Games_With_Python repo):
1. Copy this folder link: https://github.com/guoweier/100_Games_With_Python/tree/main/3_candycrush
...
For example:
```
cd C:\Users\YourName\Downloads\3_candycrush
```
2. Run
```
