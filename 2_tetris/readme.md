...
If you want just the Tetris project (not the entire 100_Games_With_Python repo):
1. Copy this folder link: https://github.com/guoweier/100_Games_With_Python/tree/main/2_tetris
...
For example:
```
cd C:\Users\YourName\Downloads\2_tetris
```
2. Run
```
python tetris.py
